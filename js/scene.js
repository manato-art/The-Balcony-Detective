...
(function (root) {
  ...
  const SIZE = {
    ...
    bag_brand:0.88, bag_conv:0.72, beads:0.45, bike:1.25, bonsai:0.75, books:0.58,
    ...
    box_tall:1.1, broom:1.3, bucket:0.95, bulb:0.41, calendar:0.8, camera:0.55,
    can:0.42, can_energy:0.42, can_tower:0.95, candle:0.43, cat_toy:0.65, chairs:1.15,
    chime:0.55, cobweb:0.55, cosplay_prop:1.18, crystal:0.48, dakimakura:1.35, dress:1.25,
    dress_shoes:0.9, dryflower:0.82, dumbbell:0.5, eyemask:0.41, fan_elec:0.85, firewood:0.82,
    flag:1.2, flute:0.72, flyer:0.42, futon:1.15, gamepad:0.47, glow:0.5,
    golf:1.2, guitar:1.2, happi:1.18, hat_item:0.55, hiking_boots:0.92, jersey:1.22,
    judo:1.24, keyboardp:0.5, kids:1.07, lace:1.2, lamp:1.2, lantern:0.78,
    ...
    pcase:0.9, petbowl:0.4, plant:0.75, plant_big:1.5, protein:0.6, resume:0.4,
    ring:0.98, rod:1.5, sack:0.85, sake:1, salt:0.4, sandal:0.9,
    sandal_leopard:0.9, sandal_white:0.9, scrub:1.22, sec_chest:0.58, sec_goldhato:0.58, sec_ufo:0.48,
    skate:1.12, skirt:1.06, slide_toy:1.45, star:0.95, stroller:1.25, suit:1.24,
    suitcase:1.19, surf:1.4, tank:1.1, tapioca:0.5, tarot:0.45, teddy:0.75,
    testtube:0.55, tomato:0.85, towel:1.17, towel_sport:1.17, towel_white:1.12, tricycle:0.95,
    trophy:0.68, tube:1.08, uchiwa:0.58, umbrella:1.05, uwabaki:0.55, wig:0.62,
    wine:0.85, workwear:1.22, yogamat:0.75, tripod:1.35,
    ...
    diary:0.42, director_chair:1.1, dust_layer:0.4, egg:0.36, empty_clothesline:0.45, empty_corner:0.5,
    ...
    postcard:0.4, poster_tube:0.95, pullup_bar:0.55, ring_light:1.3, rolled_poster:1.05, safety_net:1.4,
    sailor_uniform:1.05, sakaki_branch:0.65, sandal_glitter:0.4, scissor_case:0.42, shoe_pile:0.55, sleeping_bag:0.8,
    slippers:0.4, spacesuit:1.4, stage_costume:1.2, stepladder:1.05, sun_cushion:0.45, sunglasses:0.42,
